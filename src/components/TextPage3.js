  ...
  return (
    <div className="textpage3">
      <div className="page3-text">
        ...
        <p>
          Підтримати нас можна кількома способами, ми будемо вдячні за будь-яку
          допомогу. Це зробить нашу роботу кращою та ефективнішою.
        </p>
      </div>
      <div className="page3-main">
        <div className="page3-main-text">
          ...
          <p>
            Обстріли над головою, руйнування житла, втрата роботи, зачинені
            магазини та аптеки.
          </p>
          <p>Зруйновані плани на майбутнє та маленькі діти на руках.</p>
          <p>
            Старі люди, які не можуть поїхати, та неймовірна кількість тварин,
            що опинилася на вулиці.
          </p>
        ...
        <div className="page3-icon">
          <img src="https://an-pr-ua.github.io/aid_to_Ukraine/images/Photo 1 (2).png" />
        </div>
      </div>
    </div>
  );
