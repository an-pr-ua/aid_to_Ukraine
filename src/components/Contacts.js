        ...
        <div className="Contacts">
            ...
            <div className="contacts-img">
                <div className="contacts-img-left">
                     <img id="winter" src="images/tel.png" alt="foto winter"/>
                ...
                <div className="contacts-img-right">
                     <a href=""><img id="map" src="images/Screenshot.png" alt="map"/></a>
                </div>
            </div>
            <div className="contacts-form">
                <div className="contacts-form-left">
                    <h1>Запит на додаткову нформацію</h1>
                    <p>Якщо ви не знайшли інформацію, яка вас цікавить, заповніть, будь ласка, форму праворуч. Ми надішлемо відповідь на вашу електронну пошту.</p>
                </div>
